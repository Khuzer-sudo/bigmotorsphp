                    ...
                    <div class="col-12 my-5">
                        <div>
                            <div class="d-flex align-items-center justify-content-end my-5">
                                ...
                                <div>
                                    <img class="img-logo-modal" src="../img/img-verificar-pass.png">
                                </div>
                            </div>
                        </div>
                        <div class="centrado">
                            <div class="my-5">
                                <span class="title-white">
                                    TE ACABAMOS DE ENVIAR UN CÓDIGO DE CONFIRMACIÓN.<br> INTRODÚCELO EN EL SIGUIENTE APARTADO. 
                                </span>
                            </div>
                            <form method="POST" action="">
                                <div>
                                    <input class="centrado verification-password" type="text" name="" placeholder="CODIGO DE VERIFICACIÓN">
                                </div>
                            </form>
                        </div>
                        <div>
                            ...
                            <div class="d-flex mb-5">
                                <div class="d-flex justify-content-center img-cat">
                                    <a class=" btn-white2" href="">
                                        CERRAR SESIÓN
                                    </a>
                                </div>
                                <div class="d-flex justify-content-center img-cat">
