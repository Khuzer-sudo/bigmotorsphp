...
<html>
    ...
    <body>
        ...
        <!----/HEADER---->
        <!----BODY---->
        <div style="background:#000000;" class="py-5">
            <div class="container">
                <div class="row">
                    <div class="my-4">
                        <div class="d-flex justify-content-end mb-5">
                            <div>
                                <a class="btn-red2 py-2 px-4" href="">
                                    IR A TIENDA
                                </a>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="btn-red2 pb-5">
                                <div>
                                    <img class="img-50 my-2" src="../img/img-empaquetado.png">
                                </div>
                                <div>
                                    <span>
                                        EMPAQUETADO
                            ...
                            <div class="separacion4 mx-4"></div>
                            <div class="btn-red2 pb-5">
                                <div>
                                    <img class="img-50 my-2" src="../img/img-enviado.png">
                                </div>
                                <div>
                                    <span>
                                        EN CAMINO
                            ...
                            <div class="btn-red2 pb-5">
                                <div>
                                    <img class="img-50 my-2" src="../img/img-entregado.png">
                                </div>
                                <div>
                                    ENTREGADO
                                </div>
            ...
            <div class="container">
                ...
                <div class="separacion3 my-5"></div>
            </div>
        </div>
        <!----/BODY---->
        <!----FOOTER---->
