...
<html>
    ...
    <body>
        ...
        <!----/HEADER---->
        <!----BODY---->
        <div style="background: #211F1F;">
            <div class="container">
                <div class="row">
                    <div class="col-12 my-5">
                        <div>
                            <div class="d-flex justify-content-end align-items-center my-5 box-password">
                                <div class="me-4">
                                    <span class="subt-white-footer">
                                ...
                                <div>
                                    <img class="img-logo-modal" src="../img/img-forgot-pass.png">
                                </div>
                            </div>
                        </div>
                        <div class="my-5">
                            <div class="centrado mb-5">
                                <span class="title-white">
                                    INGRESA TU CORREO ELECTRÓNICO O<br>NUMERO DE CELULAR PARA BUSCAR<br>TU CUENTA
                                </span>
                            </div>
                            <div>
                            <form class="centrado" method="POST" action="">
                                <div>
                                    <input class="centrado verification-password" type="email" name="" placeholder="✉ CORREO">
                                </div>
                            </form>
                        </div>
                        <div class="d-flex justify-content-evenly my-5">
                            <a class="btn-red2 py-2 px-5" href="../index.php">
                                CANCELAR
                            </a>
                            <a class="btn-red2 py-2 px-5" href="verification.php">
                                RECUPERAR
                            </a>
                        </div>
                    </div>
